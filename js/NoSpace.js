...
export default class HelloWorldSceneAR extends Component {
    constructor() {
        ...
        this.planets = {
            "sun": {
                titleText: "Il Sole",
                descriptionText: "Il Sole (dal latino: Sol) è la stella madre del sistema solare, attorno alla quale orbitano gli otto pianeti principali (tra cui la Terra). La massa del Sole rappresenta da sola il 99,86% della massa complessiva del sistema solare.",
                planetVideo: require('./res/planetsVideos/sun.mp4')
            },
            "mercury": {
                titleText: "Mercurio",
                descriptionText: "Conosciuto sin dal tempo dei Sumeri, il suo nome è tratto dalla mitologia romana. Il pianeta è stato associato a Mercurio, messaggero degli dei, probabilmente a causa della sua rapidità di movimento nel cielo. E' il pianeta più interno del sistema solare e il più vicino al Sole"
            },
            "venus": {
                titleText: "Venere",
                descriptionText: "Prende il nome dalla dea romana dell'amore e della bellezza.Venere è il secondo pianeta del Sistema solare in ordine di distanza dal Sole con un'orbita quasi circolare che lo porta a compiere una rivoluzione in 224,7 giorni terrestri."
            },
            "earth": {
                titleText: "La Terra",
            ...
            "mars": {
                titleText: "Marte",
                descriptionText: "Marte prende il nome dall'omonima divinità della mitologia romana.Marte è il quarto pianeta del sistema solare in ordine di distanza dal Sole; è visibile a occhio nudo ed è l'ultimo dei pianeti di tipo terrestre dopo Mercurio, Venere e la Terra. "
            },
            "jupiter": {
                titleText: "Giove",
                descriptionText: "Giove (dal latino Iovem) è il quinto pianeta del sistema solare in ordine di distanza dal Sole e il più grande di tutto il sistema planetario: la sua massa corrisponde a due volte e mezzo la somma di quelle di tutti gli altri pianeti messi insieme."
            },
            "saturn": {
                titleText: "Saturno",
            ...
            "uranus": {
                titleText: "Urano",
                descriptionText: "Urano è il settimo pianeta del sistema solare in ordine di distanza dal Sole, il terzo per diametro e il quarto per massa.L'atmosfera del pianeta contiene una proporzione elevata di acqua, l'ammoniaca e metano, assieme a tracce di idrocarburi"
            },
            "neptune": {
                titleText: "Nettuno",
                descriptionText: "Nettuno è l'ottavo e più lontano pianeta del Sistema solare partendo dal Sole. Ha una composizione simile a quella di Urano e possiede i venti più forti di ogni altro pianeta"
            },
            "plutone": {
                titleText: "Plutone",
